...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <form method="GET" action="{{ route('admin.reports.sales') }}" class="flex flex-wrap gap-4 items-end">
            ...
            <a href="{{ route('admin.reports.print', ['type' => 'sales', 'start_date' => $startDate, 'end_date' => $endDate]) }}" target="_blank" class="px-6 py-2 bg-gray-600 text-white rounded-lg hover:bg-gray-700 transition font-medium">
                Cetak
            </a>
        </form>
    </div>
